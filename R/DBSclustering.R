DBSclustering=function(k,DataOrDistance,BestMatches, ColumnsLines,StructureType=TRUE,
                       PlotIt=FALSE,ylab,main,method='euclidean',...){
  #Cls=DBSclustering(k,Data,BestMatches,ColumnsLines,StructureType=TRUE,PlotIt=F,method='euclidean')
  ...
  GOutput      = Delaunay4Points(Points   = BestMatches, ColumnsLines = ColumnsLines,

...
arma::cube Delta3DWeightsC_internal(arma::cube x,
...
arma::cube trainstepC(Rcpp::NumericVector vx,
  ...
  for(int p=0;p<NumberOfDataSamples;p++){
    ...
    inputdiff=Delta3DWeightsC_internal(esomwts,DataSample); //MT: Ohne Multiplikation mit 1 ist esom==inputdiff, kA wieso
